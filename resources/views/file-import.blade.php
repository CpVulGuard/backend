            ...
            <div class="form-group mb-4" style="max-width: 500px; margin: 0 auto;">
                <div class="custom-file text-left">
                    ...
                    <div class="mt-4 ml-16">
                        <label class="custom-file-label mr-8" for="customReason" id="customLabel">Reason: </label>
                        <input type="text" name="reason" class="custom-reason-input" id="customReason" required>
                    </div>
                </div>
            </div>
